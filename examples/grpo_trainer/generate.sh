...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=2,3 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/nobackup2/windy/verl-agent-master/checkpoints/verl_agent_webshop/gigpo-llama3.23b_lr2e-6envstep10//global_step_440/hf \
    ...
    trainer.experiment_name='class0.02_gigpo-7b' \
    trainer.n_gpus_per_node=2 \
    trainer.nnodes=1 \
    trainer.save_freq=40 \
    trainer.test_freq=10 \
    trainer.total_epochs=880 \
