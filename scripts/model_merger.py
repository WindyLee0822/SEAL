...
python scripts/model_merger.py merge \
    --backend fsdp \
    --local_dir /nobackup2/windy/verl-agent-master/checkpoints/verl_agent_webshop/grpo-1.5binstruct_lr2e-6envstep10/global_step_840/actor \
    --target_dir /nobackup2/windy/verl-agent-master/checkpoints/verl_agent_webshop/grpo-1.5binstruct_lr2e-6envstep10/global_step_840/hf
```
